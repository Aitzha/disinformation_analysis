...
class FullUserAPITests(APITestCase):
    def test_userAndPersonalityExist_returnCorrectJson(self):
        ...
        self.assertEqual(response_data['personality']['user'], user.user_id)
...
class FullPostAPITests(APITestCase):
    def test_postExistAndNoResponse_returnCorrectJson(self):
...
class UserResponseAPITests(APITestCase):
    def test_userExistAndZeroResponses_returnCorrectJson(self):
        user = UserFactory.create()
    ...
    def test_userExistAndTwoResponses_returnCorrectJson(self):
        user = UserFactory.create()
