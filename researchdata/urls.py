...
urlpatterns = [
    ...
    path('api/simple/user/<int:user_id>', api.simple_user, name='simple_user_api'),
    path('api/simple/user_response/<int:user_id>', api.simple_user_responses, name='simple_user_response_api'),
    path('api/simple/post/<int:post_id>', api.simple_post, name='simple_post_api'),
    ...
    path('api/detailed/post/<int:post_id>', api.detailed_post, name='detailed_post_api'),
